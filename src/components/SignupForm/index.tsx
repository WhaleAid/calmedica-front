  ...
  return (
    <div className="max-w-xl w-full my-auto md:mx-auto mx-0 rounded-none md:rounded-2xl p-4 md:p-8 bg-white dark:bg-black transition-all">
      <div className="flex w-full justify-between gap-12 items-center mb-4">
        <img src="https://www.calmedica.com/wp-content/uploads/2020/05/Calmedica-logo-flat-200.png" alt="logo" className="w-auto h-auto" />
        <h2 className="font-bold lg:text-xl text-md text-neutral-800 dark:text-neutral-200 text-end">
          Bienvenue sur L'application Calmedica
        </h2>
      </div>
      ...
      <FormikProvider value={formik}>
        <Form className="my-8">
          ...
          <button
            className="cursor-pointer bg-gradient-to-br relative group/btn animate-shimmer from-primary dark:from-zinc-900 dark:to-zinc-900 to-primaryDark block dark:bg-zinc-800 w-full text-white rounded-full h-10 font-medium shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:shadow-[0px_1px_0px_0px_var(--zinc-800)_inset,0px_-1px_0px_0px_var(--zinc-800)_inset]"
            type="submit"
