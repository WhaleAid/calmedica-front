  ...
  return (
    <div className="max-w-xl w-full my-auto md:mx-auto mx-0 rounded-none md:rounded-2xl p-4 md:p-8 bg-white dark:bg-black transition-all">
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <button
          className="bg-gradient-to-br relative group/btn animate-shimmer from-[#FF6F01] dark:from-zinc-900 dark:to-zinc-900 to-[#CB5801] block dark:bg-zinc-800 w-full text-white rounded-full h-10 font-medium shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:shadow-[0px_1px_0px_0px_var(--zinc-800)_inset,0px_-1px_0px_0px_var(--zinc-800)_inset]"
          type="submit"
          disabled={isLoading}
        >
          Connexion &rarr;
